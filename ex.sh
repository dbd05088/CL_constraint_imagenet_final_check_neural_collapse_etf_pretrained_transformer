...
# CIL CONFIG
NOTE="sdp_pre_trained_with_neck_vit_disjoint_cifar10_mem500_iter_2_collapse_check" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
MODE="sdp"
K_COEFF="4"
TEMPERATURE="0.125"
